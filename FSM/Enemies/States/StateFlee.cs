...
namespace SK.FSM
{
    public class StateFlee : StateBase
    {
        ...
        public StateFlee(Enemy enemyControl, EnemyStateMachine stateMachine)
        {
            _enemy = enemyControl;
        ...
        private Vector3 GetFleePoint(float angle)
        {
            ...
            return _enemy.mTransform.position + (_enemy.combat.TargetObject.transform.rotation * Quaternion.Euler(0, angle, 0)) * (Vector3.forward * _enemy.fleeDistance);
        }
    }
}