...
namespace SK.FSM
{
    public class InputManager : StateAction
    {
        ...
        private readonly InputAction _Input_RollingHori;
        private readonly InputAction _Input_RollingVert;
        ...
        private bool HandleAttacking()
        {
            ...
            if (_isAttacking)
            {
                ...
                _state.stateMachine.ChangeState(_state.attackState);
            }
        ...
        {
            Vector3 targetDir = _state.cameraManager.transform.forward;
            targetDir.y = 0;
